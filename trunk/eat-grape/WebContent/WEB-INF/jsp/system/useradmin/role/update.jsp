...
<div class="pageContent">
	<form method="post" action="${ctx}/system/useradmin/role/update.htm?action=zxjsxg&navTabId=${param.navTabId}" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
