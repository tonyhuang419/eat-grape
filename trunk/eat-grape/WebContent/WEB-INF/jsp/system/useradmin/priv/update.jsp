...
<div class="pageContent">
	<form method="post" action="system/useradmin/priv/update.htm?navTabId=${param.navTabId}" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
