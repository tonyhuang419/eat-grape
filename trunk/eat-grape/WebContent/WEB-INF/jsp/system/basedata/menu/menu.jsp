...
<script type="text/javascript">
	...
	$(".menu").contextMenu('funcMgrCM', {
    	bindings : {
    		// 新增菜单
			newMenu : function(t){
				var url = "system/basedata/menu/showAdd.htm?menu.parentId=" + t.attr("id") + "&action=tjgnzs&navTabId=${navTabId}";
			...
			updateMenu : function(t){
				var url = "system/basedata/menu/showUpdate.htm?menu.id=" + t.attr("id") + "&action=xggnzs&navTabId=${navTabId}";
				var dlgId = "dialog_menu_" + t.attr("id");
			...
			deleteMenu : function(t){
	            ...
	            {
	            	var url = "system/basedata/menu/delete.htm";
