		    ...
		    <table width="100%" border="0">
		      ...
		      <tr>
		        <td>
		        	<table width="100%" border="0">
			          <tr>
			            <td width="20%" height="45" align="right">商&nbsp;家&nbsp;名&nbsp;称：</td>
			            <td width="30%" height="45">${convertGoods.name}</td>
			            <td rowspan="4">
			            	<s:if test="#request.convertGoods.picUrl == null">
			            		<img src="${ctx}/images/backend/no_photo.jpg" title="暂未上传" align="absmiddle"/>
			            	</s:if>
			            	<s:else>
			            		<img src="${ctx}${convertGoods.picUrl}" title="${convertGoods.name}" align="absmiddle"/>
			            	</s:else>
			            </td>
		              </tr>
			          <tr>
			            <td width="20%" height="45" align="right">总&nbsp;共&nbsp;数&nbsp;量：</td>
			            <td width="30%" height="45">${convertGoods.total}</td>
		              </tr>
			          <tr>
			            <td width="20%" height="45" align="right">剩 余 数 量：</td>
			            <td width="30%" height="45">${convertGoods.surplus}</td>
		              </tr>
			          <tr>
			            <td width="20%" height="45" align="right">所 需 积 分：</td>
			            <td width="30%" height="45">${convertGoods.score} 积分</td>
		              </tr>
			          <tr>
			            <td width="20%" height="45" align="right">商 品 描 述：</td>
