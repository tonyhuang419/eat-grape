...
<div class="pageContent">
	<form method="post" action="${ctx}/admin/foundation/scoreshop/convertRecords/add.htm?navTabId=${navTabId}&action=zxdytj&dialogId=${dialogId}" class="pageForm required-validate"
