...
<form id="pagerForm" method="post" action="${ctx}/admin/foundation/place/school/showIndex.htm?action=city_school_area&TabId=${param.navTabId}">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="${ctx}/admin/foundation/place/school/showIndex.htm?action=zxdyss" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="${ctx}/admin/foundation/place/school/showAdd.htm?action=tjdyzs&navTabId=${param.navTabId}" target="dialog" mask="true" width="520" height="250"><span>添加学校</span></a></li>
			<li><a class="delete" href="${ctx}/admin/foundation/place/school/delete.htm?school.id={sid}&action=zxdysc&navTabId=${param.navTabId}" target="ajaxTodo" title="确定要删除吗？"><span>删除</span></a></li>
			<li><a class="edit" href="${ctx}/admin/foundation/place/school/showUpdate.htm?school.id={sid}&action=xgdyzs&navTabId=${param.navTabId}" target="dialog" mask="true" width="520" height="250"><span>学校修改</span></a></li>
		</ul>
	</div>
