...
<div class="pageContent">
	<form method="post" action="${ctx}/admin/foundation/place/school/add.htm?navTabId=${navTabId}&action=zxdytj&dialogId=${dialogId}" 
		class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
		<div class="pageFormContent" layoutH="56">
			<p>
				<label>学校名称：</label>
				<input name="school.name" class="required" type="text" size="35" alt="请输入学校名称"/>
			</p>
			<p>
				<label>英文名称：</label>
				<input name="school.englishName" type="text" size="35" alt="请输入英文名称"/>
			</p>
				<label>所属区域：</label>
