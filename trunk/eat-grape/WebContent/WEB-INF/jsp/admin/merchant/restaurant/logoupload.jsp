...
<div class="pageContent">
	<form id="uploadForm" method="post" action="${ctx}/admin/merchant/restaurant/restaurantLogoUpload.htm?id=${restaurant.id}&action=zxzhxg" enctype="multipart/form-data" class="pageForm required-validate" >
