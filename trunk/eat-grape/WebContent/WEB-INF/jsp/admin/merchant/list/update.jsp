...
<div class="pageContent">
	<form method="post" action="${ctx}/admin/merchant/list/update.htm?action=zxzhxg&navTabId=${param.navTabId}" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
		<div class="pageFormContent" layoutH="56" align="right">
			...
			<p>
				<label>商家名称：</label>
				<input name="merchant.merchantName" type="text" size="42" class="required" value="${merchant.merchantName}" />
			</p>
			<p>
				<label>商家电话：</label>
			...
			<p>
				<label>商家地址：</label>
				<input type="text"  name="merchant.merchantAddress" size="42" class="required" value="${merchant.merchantAddress}" />
			</p>
			<p>
				<label>商家邮箱：</label>
			...
			<p>
				<label>身份证号码：</label>
				<input type="text"  name="merchant.legalIdCard" size="42" class="textInput" value="${merchant.legalIdCard}" />
			</p>
			<p>
				<label>法定人电话：</label>
			...
			<p>
				<label>法定人家庭地址：</label>
				<input type="text"  name="merchant.legalHomeAddress" size="42" class="textInput" value="${merchant.legalHomeAddress}" />
			</p>
			<p>
				<label>法定人现居地址：</label>
				<input type="text"  name="merchant.legalAddress" size="42" class="textInput" value="${merchant.legalAddress}" />
			</p>
		</div>
		<div class="formBar">
			<ul>
