...
public class VelocityLayoutResult extends VelocityResult {
    ...
    private void generatorContent(String finalLocation, ActionInvocation invocation)throws Exception {
        ...
        try {
    		...
    		Date cur_time = Calendar.getInstance(invocation.getInvocationContext().getLocale()).getTime();
    ...
    private void initLayoutTemplateParameters(){
        ...
        if (errorTemplate == null) {
        	errorTemplate = (String) velocityManager.getVelocityEngine().getProperty(PROPERTY_ERROR_TEMPLATE);
        ...
        LOG.info("VelocityLayoutResult: Default layout template is '" + defaultLayout + "'");
    }
