...
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='社区（片区或小区）表';
...
CREATE TABLE `t_district` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='省、市、区 表....';
...
CREATE TABLE `t_privilege` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=120 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='权限表';
...
CREATE TABLE `t_role` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='角色表';
...
CREATE TABLE `t_role_privilege` (
  ...
  KEY `priv_id` (`priv_id`),
  KEY `role_id` (`role_id`)
) ENGINE=MyISAM AUTO_INCREMENT=172 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='角色与权限关联表';
...
--  Records 
-- ----------------------------
INSERT INTO `t_community` VALUES ('1','qqqqz','qqqqqqqqqqqq',NULL,NULL), ('3','q','qqq',NULL,NULL);
INSERT INTO `t_district` VALUES ('1','北京市','beijing1',NULL), ('2','天津市','tianjin',NULL), ('3','重庆市','chongqing',NULL), ('4','上海市','shanghai',NULL), ('5','湖南省','hunan',NULL), ('6','广东省','guangdong',NULL), ('11','湘潭市','xt','5'), ('8','海淀区','hd','7'), ('9','朝阳区','cy','7'), ('10','长沙市','cs','5'), ('12','株洲市','zz','5'), ('14','广州市','gz','6'), ('15','深圳市','sz','6'), ('7','北京市','beijing','1');
...
INSERT INTO `t_privilege` VALUES ('1','系统管理','系统管理','sys_mgr','','1',NULL), ('2','用户管理权限','用户管理','user_mgr','','1','1'), ('118','后台用户操作日志','后台用户操作日志','admin/backendoperatorlog','','1','117'), ('4','权限管理权限','权限管理','system/useradmin/priv/showIndex.htm','','1','2'), ('5','功能设置权限','功能设置','func_mgr','','1','3'), ('6','执行权限搜索',NULL,'zxqxss',NULL,'0','4'), ('7','添加权限展示','','tjqxzs','xx',NULL,'4'), ('8','执行权限添加',NULL,'zxqxtj',NULL,'0','4'), ('9','角色管理权限','角色管理','system/useradmin/role/showIndex.htm','','1','2'), ('10','执行角色搜索',NULL,'zxjsss',NULL,'0','9'), ('11','添加角色展示',NULL,'tjjszs',NULL,'0','9'), ('12','执行角色添加',NULL,'zxjstj',NULL,'0','9'), ('13','执行角色删除',NULL,'zxjssc',NULL,'0','9'), ('14','修改角色展示',NULL,'xgjszs',NULL,'0','9'), ('15','执行角色修改',NULL,'zxjsxg',NULL,'0','9'), ('16','权限分配展示',NULL,'qxfpzs',NULL,'0','9'), ('17','执行权限分配',NULL,'zxqxfp',NULL,'0','9'), ('18','子权限列表展示',NULL,'zqxlbzs',NULL,'0','4'), ('19','执行权限删除',NULL,'zxqxsc',NULL,'0','4'), ('20','修改权限展示',NULL,'xgqxzs',NULL,'0','4'), ('21','执行权限修改',NULL,'zxqxxg',NULL,'0','4'), ('22','账号管理权限','账号管理','system/useradmin/account/showIndex.htm','','1','2'), ('23','执行账号搜索',NULL,'zxzhss',NULL,'0','22'), ('24','添加账号展示',NULL,'tjzhzs',NULL,'0','22'), ('25','执行账号添加',NULL,'zxzhtj',NULL,'0','22'), ('26','执行账号删除',NULL,'zxzhsc',NULL,'0','22'), ('27','修改账号展示',NULL,'xgzhzs',NULL,'0','22'), ('28','执行账号修改',NULL,'zxzhxg',NULL,'0','22'), ('117','系统数据','系统数据','admin/systemdata','','1','1'), ('34','导出账号Excel',NULL,'dzzhexcel',NULL,'0','22'), ('110','基础数据','基础数据管理','','','1',NULL), ('111','区域管理','区域管理','/foundation/place/district/showIndex.htm','','1','110'), ('112','学校管理','学校管理','/foundation/place/shool/showIndex.htm','','1','110'), ('113','社区管理','社区管理','/foundation/place/community/showIndex.htm','','1','110'), ('114','商家管理','商家管理','admin/merchant','','1',NULL), ('115','订单管理','订单管理','admin/order','','1',NULL), ('116','顾客管理','顾客管理','admin/customer','','1',NULL), ('119','前台用户操作日志','前台用户操作日志','admin/frontuseroperatorlog','','1','117');
...
INSERT INTO `t_role_privilege` VALUES ('158','3','34'), ('159','3','5'), ('160','3','29'), ('161','3','30'), ('162','3','31'), ('163','3','32'), ('164','3','33'), ('165','2','110'), ('166','2','111'), ('167','2','112'), ('168','2','113'), ('169','2','114'), ('170','2','115'), ('171','2','116');
INSERT INTO `t_shool` VALUES ('1','dddd','eeeeeeeeeee',NULL,NULL);
