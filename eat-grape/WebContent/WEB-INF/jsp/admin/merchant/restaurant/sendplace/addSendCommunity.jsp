...
<script type="text/javascript" src="${ctx}/js/backend/merchant/restaurant/sendplace/addSendCommunity.js"></script>

<div class="pageContent">
	<form id="addForm" method="post" action="${ctx}/admin/merchant/restaurant/sendplace/addSendCommunity.htm?navTabId=${navTabId}&action=zxdytj&dialogId=${dialogId}" 
		class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
		<div class="pageFormContent" layoutH="56">
			<input name="communityRestaurant.restaurantId" type="hidden" value="${restaurant.id}" />
			<label>选择送餐社区：</label>
			...
			<select class="combox" id="w_combox_district" ref="w_combox_community" refUrl="${ctx}/admin/foundation/place/community/getCommunitiesByDistrictId.htm?community.districtId={value}">
				<option value="">区域</option>
			</select>
			<select class="combox" id="w_combox_community" name="communityRestaurant.communityId">
