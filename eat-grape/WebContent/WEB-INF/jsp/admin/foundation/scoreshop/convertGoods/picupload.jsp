...
<div class="pageContent">
	<form id="uploadForm" method="post" action="${ctx}/admin/foundation/scoreshop/convertGoods/convertGoodsPicUpload.htm?id=${convertGoods.id}&action=zxzhxg" enctype="multipart/form-data" class="pageForm required-validate" >
