...
<div class="pageContent">
	<form method="post" action="${ctx}/admin/foundation/place/community/update.htm?action=zxdyxg&navTabId=${param.navTabId}" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
		<div class="pageFormContent" layoutH="56">
			...
			<p>
				<label>社区名称：</label>
				<input name="community.name" class="required" type="text" size="35" value="${community.name}" alt="请输入社区名称"/>
			</p>
			<p>
				<label>名称拼音：</label>
				<input name="community.pinyinName" type="text" size="35" value="${community.pinyinName}" alt="请输入名称拼音" />
			</p>
				<label>所属区域：</label>
