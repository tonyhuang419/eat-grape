...
<form id="pagerForm" method="post" action="${ctx}/admin/foundation/place/district/showIndex.htm?action=city_district_area&TabId=${param.navTabId}">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="${ctx}/admin/foundation/place/district/showIndex.htm?action=zxdyss" method="post">
	<div class="searchBar">
