...
<div class="pageContent">
	<form method="post" action="${ctx}/system/useradmin/priv/update.htm?action=zxqxxg&navTabId=${param.navTabId}" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
