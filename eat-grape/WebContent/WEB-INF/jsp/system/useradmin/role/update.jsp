...
<div class="pageContent">
	<form method="post" action="system/useradmin/role/update.htm?action=zxjsxg&navTabId=${param.navTabId}" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
